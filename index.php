...
<html lang="en">
<head>
   <title>Krishna Bank - Sabka Saath Sabka Vinaash</title>
   <meta charset="utf-8">
...
<section class= "my-5">
<div class="py-5">
 <h3 class="text-center  text-bg-primary" >About Us</h3>
 </div>
<div class="container-fluid">
 <div class ="row">
<div  class="col-lg-6 col-md-6 col-12">
      ...
      <div  class="col-lg-6 col-md-6 col-12">
      <h1>Krishna Bank</h1>
      <p1> Krishna Bank is a part of Krishna foundation. It is one of Znations's leading private banks and was among the first to receive approval from the Central bank of Znation (CBZ) to set up a private sector bank in 992 ZY.
          Today, Krishna Bank has a banking network of 5,608 branches and 16,087 ATM's in 2,902 cities/towns. Krishna Bank offers a diverse range of financial products and banking services to customers(Which are dead actually, because they are ZOMBIES) through a growing branch and ATM network and digital channels such as Netbanking, Phonebanking and MobileBanking.
...
<footer class="text-center mt-2 py-4 bg-warning">
        <p>&copy 2021  <b>Krishna Jaiswal</b> </br>Chairman, Krishna Foundation</p>
</footer>
